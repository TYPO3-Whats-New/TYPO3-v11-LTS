...
\begin{frame}[fragile]
	...
	\small
		...
		We have implemented unified standards and state-of-the-art technologies for developers in previous TYPO3 releases.
		...
		which now also supports PHP v8.

		\vspace{0.2cm}

		TYPO3 v11 LTS is built to stay.
